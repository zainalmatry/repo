  ...
  private static List<IconListItem> getItemList(Context context, boolean isEncryptedConversation) {
    ...
    if (isEncryptedConversation) {
      if (fileIdentifier == null) {
        fileIdentifier = new IconListItem(context.getString(R.string.AttachmentTypeSelectorAdapter_file), ResUtil.getDrawableRes(context, R.attr.conversation_attach_file), ADD_FILE);
      }
